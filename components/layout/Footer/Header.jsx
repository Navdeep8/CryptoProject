            ...
            <div className='relative grow flex justify-between items-start px-[1.5rem] w-full'>
                ...
                <div className="grow  justify-center items-start hidden lg:flex  text-[1.125rem] leading-[26px] font-medium text-[#A7ADB4] px-[60px]">
                    ...
                    <div className='flex flex-col grow'>
                        ...
                        <button className='flex justify-center items-center rounded-full w-[150px] h-[2rem] border-[2px] px-[1.25rem] py-[1rem] text-white mr-[0.75rem] border-gradient mb-[1rem]'>
                            Login
                        </button>
                        <button className='flex justify-center items-center rounded-full w-[150px] h-[2rem] border-[2px] px-[1.25rem] py-[1rem] text-[#C0F821] border-[#C0F821]'>
                            Sign Up
                        </button>
                    </div> 
                </div>
